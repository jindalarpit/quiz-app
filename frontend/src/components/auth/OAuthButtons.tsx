 ...
 * Redirects to the backend OAuth initiation endpoint.
 */
...
/**
 * GitHub sign-in button styled with GitHub's dark theme.
 * Redirects to the backend OAuth initiation endpoint.
 */
...
/**
 * OAuthButtons component renders Google and GitHub sign-in buttons
 * with an "or" divider for use on login/register pages.
 */
...
export { GoogleSignInButton, GitHubSignInButton };
